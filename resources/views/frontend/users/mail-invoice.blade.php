...
<body>
    <div class="text-center">
        ...
        <p>Thank you for purchasing with Luxe</p><br>
        ...
        <thead>
            <tr>
                <th width="50%" colspan="2">
                    <h2 class="text-start">Luxe ECommerce</h2>
                </th>
                <th width="50%" colspan="2" class="text-end company-data">
                    <span>Invoice Id: #{{ $order->id }}</span> <br>
                    <span>Date: {{ date('d /m / Y') }}</span> <br>
                    <span>Zip code : 20500</span> <br>
                    <span>Address:123 Main Street, Colombo-12, Sri Lanka</span> <br>
                </th>
            </tr>
            <tr class="bg-blue">
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with Luxe
    </p>
